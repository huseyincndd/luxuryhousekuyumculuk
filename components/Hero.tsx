  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto mt-0 md:mt-20 flex flex-col items-center">
        <div className="inline-block border-b border-luxury-gold/50 pb-3 mb-5 md:mb-6 animate-fade-in-up">
           <h2 className="text-luxury-gold text-xs md:text-sm tracking-[0.3em] md:tracking-[0.5em] uppercase font-bold">
            Altın • Pırlanta • Mücevher
          </h2>
        </div>
        
        <h1 className="font-serif text-6xl md:text-7xl lg:text-8xl text-white mb-7 md:mb-8 leading-[1.15] md:leading-tight drop-shadow-2xl animate-fade-in-up" style={{animationDelay: '0.2s'}}>
          Saf Altın, <br />
          <span className="gold-gradient-text italic font-normal">Saf Zarafet</span>
        </h1>
        
        <p className="font-sans text-gray-200 text-lg md:text-xl tracking-wide mb-8 md:mb-12 max-w-lg md:max-w-2xl mx-auto font-light leading-relaxed drop-shadow-md animate-fade-in-up" style={{animationDelay: '0.4s'}}>
          İstanbul Beylikdüzü'nde, özel tasarım altın takılar, pırlanta yüzükler ve değerli taş koleksiyonlarıyla size hizmet veriyoruz.
        </p>
